...
var PagesRegistry = []PageInfo{
	...
	{Code: "tv", Title: "Пульт ТВ", Icon: "📺", DefaultVisibility: "personal"},
	...
	{Code: "ai", Title: "AI", Icon: "✨", DefaultVisibility: "personal"},
	{Code: "calendar", Title: "Calendar", Icon: "📅", DefaultVisibility: "all"},
	{Code: "tests", Title: "Тесты", Icon: "🧠", DefaultVisibility: "personal"},
	{Code: "finance", Title: "Finance", Icon: "💰", DefaultVisibility: "personal"},
	{Code: "mail", Title: "Почта", Icon: "📬", DefaultVisibility: "personal"},
	{Code: "vault", Title: "Сейф", Icon: "🔐", DefaultVisibility: "personal"},
...
var FeaturesRegistry = []FeatureInfo{
	...
	{Code: "mail.receipts", Page: "mail", Title: "Чеки магазинов → траты в Finance"},
}

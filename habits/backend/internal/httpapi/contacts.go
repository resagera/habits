...
var shareKindMsg = map[string]struct{ Applied, Queued string }{
	...
	"checker_share":     {"👥 %s открыл вам совместный доступ к списку «%s» — он появился на вкладке Checker в Habits.", "👥 %s хочет открыть вам совместный доступ к списку «%s» — принять можно на странице Contacts в Habits."},
	...
	"vault_folder":      {"🔐 %s открыл вам доступ к папке сейфа «%s» — она появилась на вкладке Сейф в Habits. Пароль от папки владелец должен прислать отдельно: сервер его не знает.", "🔐 %s хочет открыть вам доступ к папке сейфа «%s» — принять можно на странице Contacts в Habits. Пароль владелец пришлёт отдельно."},
	"vault_file":        {"🔐 %s открыл вам доступ к файлу в сейфе (%s) — он появился на вкладке Сейф в Habits. Пароль от папки владелец должен прислать отдельно: сервер его не знает.", "🔐 %s хочет открыть вам доступ к файлу в сейфе (%s) — принять можно на странице Contacts в Habits. Пароль владелец пришлёт отдельно."},
	"food_plan":         {"📅 %s открыл вам доступ к плану питания «%s» — он появился на вкладке Food → План в Habits.", "📅 %s хочет открыть вам доступ к плану питания «%s» — принять можно на странице Contacts в Habits."},
}
